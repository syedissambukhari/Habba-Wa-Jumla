  ...
  <div className="w-full  max-w-[1920px] lg:h-[500px] pt-12 lg:pl-[135px] lg:pr-[465px] lg:pb-[124pgap-8     px-6 ">
   <div className='max-w-[1320px] h-auto lg:h-[240px] gap-6  '>
      ...
      <form className='grid grid-rows-1 gap-6 lg:grid-rows-1 lg:gap-[24px] w-full lg:w-[872px] sm:grid-cols-2'>
        ...
        <label htmlFor="orderId" className="text-[14px] font-medium leading-[20px] text-left font-public-sans  text-[#191C1F] ">Order ID</label>
        ...
        <div>
          <label htmlFor='emailAddress' className='text-[14px] font-medium leading-[20px] text-left font-public-sans  text-[#191C1F]'>Billing Email</label>
           <input
           id='emailAddress'
           type='email'
         ...
         <BsInfoCircle className="w-[22px] h-[21px] gap-0 top-[6.75px] left-[10.69px] text-gray-600 mr-2

"/>
         <p className="text-[14px] font-normal leading-[20px] font-public-sans text-[#5F6C72]  "> Order ID that we sended to your on your email address.</p>
         ...
         <div className="col-span-2">
          <button
            ...
            "
          >
            <h6 className="font-public-sans text-[16px] font-bold leading-[56px] tracking-[0.012em] text-left text-white"> TRACK ORDER</h6>

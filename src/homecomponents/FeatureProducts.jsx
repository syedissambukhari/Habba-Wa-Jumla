...
const FeatureProducts = () => {
  return (
    <div className="mt-[50px] grid grid-cols-12 justify-start gap-10 px-[40px]">
      {/* Left Column */}
      <div className="col-span-4 bg-[#F3DE6D] p-4 flex flex-col gap-4 h-full">
        <h6 className="text-[#BE4646] text-[14px] text-center">
          COMPUTER & ACCESSORIES
        </h6>
        <h1 className="text-[32px] text-center font-[600]">32% Discount</h1>
        <p className="text-[#475156] text-center text-[16px]">
          For all electronics products
        </p>
        <div className="flex gap-4 items-center">
          <p className="text-[14px]">Offers ends in:</p>
          <p className="text-[14px] bg-white p-2">ENDS OF CHRISTMAS</p>
        </div>

    ...
    return (
        <div className="mt-24 flex flex-col gap-3 justify-center items-center">
            ...
            <div className="flex gap-2">
                <button onClick={()=>handleNavigate()} className="pt-2 pb-2 pl-3 pr-3 flex gap-2 bg-[#0B5D51] justify-center items-center">
                    <FaArrowLeftLong color="white" />
                    <p className="font-bold text-white text-sm leading-6">GO BACK</p>
                </button>
                <Link to={"/"} className="pt-2 pb-2 pl-3 pr-3 flex gap-2 justify-center items-center">
                    <GoHome color="#0B5D51" />
                    <p className="font-bold text-[#0B5D51] text-sm leading-6">GO TO HOME</p></Link>
            </div>
        </div>
    );
}

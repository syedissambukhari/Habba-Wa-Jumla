  ...
  return (
    <div className="bg-white min-h-screen text-white p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/admin/admininovicefilter" className="flex items-center bg-[#0B5D51] hover:bg-gray-400 text-white font-semibold py-1 px-4 rounded-2xl">

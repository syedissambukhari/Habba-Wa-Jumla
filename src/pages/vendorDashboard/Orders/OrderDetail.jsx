       ...
       return (
        ...
        <div className="flex justify-between items-center mb-6 ">
          <div>
            ...
            <p className="text-sm text-gray-500">Placed on <span className="font-medium">31/01/2024 11:19</span></p>
          </div>
          <div className="flex space-x-4">
            <button className="text-black flex items-center gap-2 ">Edit  <MdOutlineEdit />
            </button>
            <div className="relative">
              <button className="bg-[#0B5D51] text-white py-2 px-4 rounded-lg">Action</button>
            </div>
          </div>
        </div>
...
<div className="bg-white flex items-center p-4 rounded-lg w-full border space-x-3  border-gray-300">
  ...
  <button  className='w-[70px] rounded-lg text-white h-[40px] mt-6 bg-[#0B5D51]'>Save</button>
</div>
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="text-left py-2 px-4 text-gray-600">Billing Cycle</th>
        ...
        {/* Logs Section */}
        <div className="bg-white flex flex-col p-6 rounded-lg shadow-md mb-6">
          ...
          <button className="text-black underline mt-4">Load more</button>
        </div>
      </div>
       )
     }

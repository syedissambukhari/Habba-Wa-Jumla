    ...
    return (
            ...
            <div className="flex">
                ...
                <div className="w-full">
                    ...
                    <div className="flex justify-between">
                        ...
                        <p className="mb-2 text-[#6C737F] text-sm font-medium">Toggling this will let your teammates
        ...
        <div className="mb-8 p-8 rounded-lg shadow-[0px_2px_10px_3px_#0B5D5180]">
            <div className="flex">
                ...
                <div className="w-full">
                    <p className="mb-4 text-[#111927] text-[16px] font-bold">Delete your account and all of your source
